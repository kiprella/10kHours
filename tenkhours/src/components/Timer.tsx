...
export default function Timer({ settings, activity, onComplete }: TimerProps) {
  ...
  return (
    <div className="flex flex-col items-center space-y-8 py-4">
          ...
          <div className="flex items-center gap-4">
            <div className="relative flex-1">
              <input
                ...
                className="block w-full px-4 py-2.5 rounded-lg border border-gray-200 
                         text-lg font-medium text-gray-700
                         focus:border-[#4F46E5] focus:ring-2 focus:ring-[#4F46E5] focus:ring-opacity-20
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-lg text-[#4F46E5] font-medium
      ...
      <div className="relative w-48 h-48 flex items-center justify-center rounded-full border-4 border-[#4F46E5] bg-white shadow-lg">
        <div className="text-center">
          <div className="text-5xl font-bold text-[#4F46E5]">{formatTime(timeLeft)}</div>
          <div className="text-lg text-gray-600 mt-2">{activity.name}</div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        {isRunning && (
          <button
            ...
            className="btn-primary bg-[#34D399] hover:bg-[#10B981] flex items-center gap-2 min-w-[100px] justify-center"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
      ...
      {isCompleted && (
        <div className="w-full transform transition-all duration-500 ease-in-out">
          <div className="p-6 bg-[#34D399] bg-opacity-10 border border-[#34D399] rounded-lg text-center">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <p className="text-xl font-medium text-gray-800">Focus session completed!</p>
            </div>
            <p className="text-sm text-gray-600 mb-4">Great job staying focused!</p>
            <button
              onClick={handleReset}
              className="btn-primary bg-[#34D399] hover:bg-[#10B981] flex items-center gap-2 mx-auto"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
